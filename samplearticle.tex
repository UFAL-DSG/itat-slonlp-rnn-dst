...
\OD{před citace vlož všude nedělitelnou mezeru (tildu), vypadá to líp.}
...
% \label{sec:joint}
% The Joint model uses a single classifier to predict a tuple of slots (see Figure~\ref{fig:encjoint}).
...
The results in Table~\ref{tab:split} show that the complexity of the task dropped significantly.
