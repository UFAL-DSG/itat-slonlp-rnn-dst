...
The dialog state tracker summarizes hidden information state (HIS) \cite{todo} of the conversation history into formal language typically represented as a dialog act item (DAI) $(actionType, slotName, slotValue)$.
