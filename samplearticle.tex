...
We describe state-of-the art word-by-word dialogue state \st{trackers} \PB{tracker (je to porad ve smyslu pridavneho jmena, ze?)} architectures and propose to use a new encoder-decoder architecture for the DST task (see Section~\ref{sec:eval}).
